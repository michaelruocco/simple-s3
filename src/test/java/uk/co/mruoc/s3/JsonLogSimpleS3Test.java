...
public class JsonLogSimpleS3Test {
    ...
    private final Logger logger = LoggerFactory.getLogger(JsonLogSimpleS3Test.class);

    private final SimpleS3 simpleS3 = new JsonLogSimpleS3(s3, logger);
