...
public class LogSimpleS3Test {
    ...
    private final Logger logger = LoggerFactory.getLogger(LogSimpleS3Test.class);

    private final SimpleS3 simpleS3 = new LogSimpleS3(s3, logger);
